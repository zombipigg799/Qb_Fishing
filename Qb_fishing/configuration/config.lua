...
Config.fish = {
    { item = 'tuna', label = 'Tuna', price = {360, 550}, difficulty = {'medium', 'easy', 'easy'} }, -- name is the item name of the fish(must be in DB of items) / Price is the range of price it will sell to fish buyer / difficulty is how many & how hard skillcheck is
    ...
    { item = 'Red Mullet', label = 'Red Mullet', price = {265, 320}, difficulty = {'medium', 'easy'} },
    { item = 'Norwegian Salmon', label = 'Norwegian Salmon', price = {1205, 3000}, difficulty = {'medium'} },
    { item = 'Carp', label = 'Carp', price = {135, 200}, difficulty = {'easy'} },
    { item = 'Sea Bass', label = 'Sea Bass', price = {435, 500}, difficulty = {'easy'} },
}
